...
export default function BlogPageClient({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const blogPosts: BlogPost[] = [
    {
      ...
      date: "2024-01-15",
      image: "/residential-community-access-control-system.jpg",
    },
    {
      ...
      date: "2024-01-10",
      image: "/business-cctv-surveillance-system.jpg",
    },
    {
      ...
      date: "2024-01-05",
      image: "/secure-network-infrastructure-for-companies.jpg",
    },
  ]
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section
          ...
          style={{
            backgroundImage: "url('/modern-technology-security-systems-background.jpg')",
        ...
        >
          ...
          <div className="relative z-10 text-center text-white px-4">
            ...
            <p className="text-xl font-light max-w-2xl mx-auto text-sky-600">{t.blogDescription}</p>
          </div>
        </section>
